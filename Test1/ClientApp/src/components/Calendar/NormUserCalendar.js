...
export class TruckCalNormUser extends Component {
    static displayName = TruckCalNormUser.name;

    constructor(props) {
        super(props);
        this.state = {
            weekdates: {}, dataTable: [], dataTable2: [], Monday: new Date(), Friday: new Date(), Mondaydata: {}, Tuesdaydata: {}, Wednesdaydata: {}, Thursdaydata: {}, Fridaydaydata: {},
    ...
    async componentDidMount() {
        document.title = "Truck Run Calendar"
        this.weekdayDates();
        this.MondayData();
        this.TuesdayData();
        this.WednesdayData();
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td className="mainTable">
                                    <MondayData mondaydata={mondayobject} date={MondayValue} time={"10-10:30 AM"} userType={"Normal"} />
                                </td>

                                <td className="mainTable">
                                    <TuesdayData tuesdaydata={tuesdayobject} date={TuesdayValue} time={"10-10:30 AM"} userType={"Normal"} />
                                </td>

                                <td className="mainTable"> <WednesdayData wednesdaydata={wednesdayobject} date={WednesdayValue} time={"10-10:30 AM"} userType={"Normal"} />
                                </td>

                                <td className="mainTable"> <ThursdayData thursdaydata={thursdayobject} date={ThursdayValue} time={"10-10:30 AM"} userType={"Normal"} />
                                </td>

                                <td className="mainTable"> <FridayData fridaydata={fridayobject} date={FridayValue} time={"10-10:30 AM"} userType={"Normal"} />
                                </td>
                            </tr>
                            <tr>
                                <td style={{ width: 20, fontSize: 14 }}>02- 02:30 PM</td>
                                <td className="mainTable">
                                    <MondayNoon mondaynoon={mondayNoonobject} date={MondayValue} time={"02-02:30 PM"} userType={"Normal"} />
                                </td>

                                <td className="mainTable">
                                    <TuesdayNoon tuesdaynoon={tuesdayNoonobject} date={TuesdayValue} time={"02-02:30 PM"} userType={"Normal"} />
                                </td>

                                    <td className="mainTable"> <WednesdayNoon wednesdaynoon={wednesdayNoonobject} date={WednesdayValue} time={"02-02:30 PM"} userType={"Normal"} />
                                </td>

                                    <td className="mainTable"> <ThursdayNoon thursnoon={thursdayNoonobject} date={ThursdayValue} time={"02-02:30 PM"} userType={"Normal"} />
                                </td>

                                    <td className="mainTable"> <FridaydayNoon fridaynoon={fridayNoonobject} date={FridayValue} time={"02-02:30 PM"} userType={"Normal"} />
                                </td>
                            </tr>
